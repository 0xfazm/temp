...
- **Net Attributed Value (NOT profit)**: 3122.9 BD  
...
### Stamp Program Analysis

**Program Type:** visit_based

- **Business Model:** Rewards customer visits (not spend amount)
- **Stamp Value:** 1.1 BD (based on average redemption worth)
- **How it works:** Each transaction earns 1 stamp; stamps redeem for rewards based on visit frequency
- **Impact on CLTV:** CLTV based on visit frequency, not transaction amounts. Redemption costs tied to visit patterns.
...
- **Projected Gross Value**: 8587 BD
- **Projected Net Value**: 7271 BD

- **Scenario band (illustrative)**:
  - Conservative (−30%): 6011 BD gross, 5089 BD net
  - Base: 8587 BD gross, 7271 BD net
  - Optimistic (+20%): 10305 BD gross, 8725 BD net
...
|---:|---:|---|---:|---:|---:|
| 1 | L4XN4ZB | Active | 0 | 25.3 | 93.562 |
| 2 | LE6NRE6 | Active | 0 | 23.1 | 90.914 |
| 3 | L74UNDI | Active | 0 | 47.3 | 86.501 |
| 4 | LKNSRW2 | Active | 1 | 25.3 | 82.97 |
| 5 | LZDOFAV | Active | 0 | 22.0 | 82.088 |
| 6 | L0OA0G6 | Active | 3 | 0.0 | 82.088 |
| 7 | LZTTE1W | Active | 10 | 11.0 | 77.674 |
| 8 | LRKFL6G | Active | 0 | 16.5 | 75.026 |
| 9 | L1CYGAZ | Active | 1 | 14.3 | 72.378 |
| 10 | L16YO5M | Active | 0 | 14.3 | 65.317 |
...
- Last transaction details: Nov 30, 2025 07:12 — collect_stamp (value=1.10)
- Transaction pattern: typically 5+ transactions per week
- Average transaction value: ~1.15 BD
...
- Last transaction details: Sep 21, 2025 16:12 — collect_stamp (value=1.10)
- Transaction pattern: less than 1 transaction per week
- Average transaction value: ~1.10 BD
...
- Last transaction details: Nov 20, 2025 08:37 — collect_stamp (value=1.10)
- Transaction pattern: typically 3–4 transactions per week
- Average transaction value: ~1.35 BD
- Current status: Active and transacting regularly
...
- Last transaction details: Sep 03, 2025 22:09 — collect_stamp (value=1.10)
- Transaction pattern: less than 1 transaction per week
- Average transaction value: ~1.10 BD
- Current status: At Risk — needs re-engagement
...
- First transaction: Oct 16, 2024
- Most recent transaction: Nov 30, 2025
- Last transaction details: Nov 30, 2025 06:55 — collect_stamp (value=1.10)
- Transaction pattern: typically 3–4 transactions per week
- Average transaction value: ~1.10 BD
- Current status: Active and transacting regularly
...
- Most recent transaction: Nov 30, 2025
- Last transaction details: Nov 30, 2025 22:08 — collect_stamp (value=2.20)
- Transaction pattern: typically 5+ transactions per week
- Average transaction value: ~1.76 BD
- Current status: Active and transacting regularly
...
- Last transaction details: Sep 11, 2025 08:56 — collect_stamp (value=1.10)
- Transaction pattern: less than 1 transaction per week
- Average transaction value: ~1.10 BD
- Current status: At Risk — needs re-engagement
...
- First transaction: Oct 17, 2024
- Most recent transaction: Nov 30, 2025
- Last transaction details: Nov 30, 2025 23:05 — collect_stamp (value=1.10)
- Transaction pattern: typically 5+ transactions per week
- Average transaction value: ~1.75 BD
- Current status: Active and transacting regularly
...
- Most recent transaction: Nov 30, 2025
- Last transaction details: Nov 30, 2025 11:34 — collect_stamp (value=1.10)
- Transaction pattern: typically 5+ transactions per week
- Average transaction value: ~1.63 BD
- Current status: Active and transacting regularly
...
- Last transaction details: Nov 29, 2025 15:47 — collect_stamp (value=1.10)
- Transaction pattern: typically 5+ transactions per week
- Average transaction value: ~1.27 BD
- Current status: Active and transacting regularly
...
- Last transaction details: Nov 27, 2025 13:03 — redeem_stamp (value=-1.10)
- Transaction pattern: less than 1 transaction per week
- Average transaction value: ~1.34 BD
...
Transaction Activity:
- First transaction: Dec 04, 2024
- Most recent transaction: Nov 30, 2025
- Last transaction details: Nov 30, 2025 10:43 — redeem_stamp (value=-1.10)
- Transaction pattern: typically 5+ transactions per week
- Average transaction value: ~1.21 BD
- Current status: Active and transacting regularly
...
- Most recent transaction: Nov 29, 2025
- Last transaction details: Nov 29, 2025 16:45 — collect_stamp (value=1.10)
- Transaction pattern: typically 5+ transactions per week
- Average transaction value: ~1.33 BD
- Current status: Active and transacting regularly
...
- Last transaction details: Sep 10, 2025 22:56 — collect_stamp (value=1.10)
- Transaction pattern: less than 1 transaction per week
- Average transaction value: ~1.10 BD
- Current status: At Risk — needs re-engagement
...
- Last transaction details: Sep 25, 2025 12:09 — collect_stamp (value=1.10)
- Transaction pattern: less than 1 transaction per week
- Average transaction value: ~1.76 BD
- Current status: At Risk — needs re-engagement
...
- First transaction: Sep 21, 2025
- Most recent transaction: Sep 21, 2025
- Last transaction details: Sep 21, 2025 13:52 — collect_stamp (value=1.10)
- Transaction pattern: less than 1 transaction per week
- Average transaction value: ~1.10 BD
- Current status: At Risk — needs re-engagement
...
- Last transaction details: Sep 28, 2025 20:16 — collect_stamp (value=1.10)
- Transaction pattern: less than 1 transaction per week
- Average transaction value: ~1.10 BD
- Current status: At Risk — needs re-engagement
...
| stamps_program | 1 | merchant.cardType | 2652 | 449 | 16.93% | 325 | 1798.50 | created_count_is_collect_stamp_events; influenced_value_is_net_attributed_value_for_users_who_redeemed |
...
- **recon_cltv_mart**: 3122.9 (info) 

- **recon_cltv_raw**: 3122.899989295006 (info) 

- **recon_delta_mart_minus_raw**: 1.0704994110710686e-05 (pass) — Threshold: 156.14 BD (adjusted for stamp program type)
...
### Reconciliation
- **CLTV (mart)**: 3122.9
- **Raw qualifying value (source-derived)**: 3122.899989295006
- **Delta (mart - raw)**: 1.0704994110710686e-05
- **Expected reasons**:
